...
async function loadForecasts() {
    try {
        ...
        const res = await fetch('http://localhost:3000/api/questionnaire-responses?type=forecast');
...
async function loadActivities() {
    try {
        ...
        const res = await fetch('http://localhost:3000/api/questionnaire-responses?type=activity');
